...
const notice = alert("주어진 박스에 글자를 넣어서 맞추시면 됩니다. 각 칸에 맞는 알파벳을 넣으시면 칸이 초록색으로 변합니다. 만약 칸은 다르지만 해당 단어에 포함된 알파벳일 경우 노란색으로 변하고, 해당 단어에 없는 알파벳일 경우 빨간색으로 칸이 칠해집니다. 총 기회는 6번입니다. 마지막으로 알파벳을 기입할 때는 소문자로 기입해주셔야 한다는 점 참고해서 즐겨주시기 바랍니다.")
